...
import { ref, computed, mergeProps, unref, withCtx, createVNode, createBlock, openBlock, createTextVNode, toDisplayString, createCommentVNode, useSSRContext } from 'vue';
...
import { e as useStudentAuthInfoStore, f as useAdminAuthInfoStore, _ as _export_sfc } from './server.mjs';
...
const _imports_0 = "" + buildAssetsURL("logo.C06kxdrM.png");
const _sfc_main$2 = {
  __name: "Disclosure",
  __ssrInlineRender: true,
  setup(__props) {
      ...
      if (!unref(isUserOrAdminLoggedIn)) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a;
            if (_push2) {
              _push2(`<span${_scopeId}>${(_a = unref(getIcons)("signIn", "w-[20px]")) != null ? _a : ""}</span><span${_scopeId}>Sign In</span>`);
            } else {
              return [
                createVNode("span", {
          ...
          disclosureButton: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              ...
              if (!unref(profilePicture)) {
                _push2(`<span${_scopeId}>${(_a = unref(getIcons)("profile", "w-[40px]")) != null ? _a : ""}</span>`);
              } else {
        ...
        _push(ssrRenderComponent(unref(_sfc_main$1), null, {
          sideMenuButton: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              _push2(`<div${_scopeId}>`);
              if (!unref(profilePicture)) {
                _push2(`<span${_scopeId}>${(_a = unref(getIcons)("profile", "w-[30px] -mb-1")) != null ? _a : ""}</span>`);
              } else {
...
export { SideBarItems as S, _sfc_main as _ };
//# sourceMappingURL=Navbar-B6pw6acn.mjs.map
