...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isDisable)) {
        _push(`<span class="absolute ml-2">${(_a = unref(getIcons)(
          "sppiner",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isDisable)) {
        _push(`<span class="absolute right-5" data-v-c8276b94>${(_a = unref(getIcons)(
          "sppiner",
          `w-[20px] transition-transform duration-300`
        )) != null ? _a : ""}</span>`);
      } else {
...
//# sourceMappingURL=sign-up-DWy3-Edc.mjs.map
