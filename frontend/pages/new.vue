      ...
      <div class="print:hidden bg-white shadow-sm border-b p-4 mb-6">
        <div class="max-w-4xl mx-auto">
          ...
          <div class="text-gray-600 mb-4">
            Total Attendance Sheets: {{ examiners.length }} (+ 1 Cover Page)
          </div>
          <button
          ...
          >
            🖨️ Print Cover Page + All Attendance Sheets
          </button>
        </div>
      </div>
            ...
            <div class="text-center z-10 px-8">
              ...
              <div class="text-emerald-600 text-lg">
                <div class="font-semibold mb-2">
                  Total Trainers: {{ examiners.length }}
                </div>
              </div>
            </div>
